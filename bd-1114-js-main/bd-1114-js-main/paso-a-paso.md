...
R: Este filtro solo utiliza saccion, edad, longitud de nombre, entonces si necesito filtros extra tengo que poner más filtros,
2. Si cierro el programa, donde quedaron los datos?
R: En este código quedan en el archivo .js
...
R: Solo hay 4 alumnos en base de datos
2. Cuantos cursos tiene cada alumno?
R: Cada alumno tiene un curso asignado, siendo 3 de 1114 y 1 de 1113
